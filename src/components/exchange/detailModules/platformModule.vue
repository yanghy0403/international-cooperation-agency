    ...
    <div class="workExperience2" v-else>
      <div class="tabDIv newTable2 newScrollbargray">
        <div v-if="internationtableDataArr.length != 0">
          <div class="tabletitle">香港联合实验室</div>
          <el-table
        ...
        <div v-if="unitDataArr.length != 0">
          <div class="tabletitle">中外联合研究单元</div>
          <el-table
            :data="unitDataArr"
            style="width: 98%;">
            <el-table-column
    ...
    watch:{
      platformData:{
        ...
        handler (val) {
          ...
          //    处理table数据
          if(this.newworkData.table.hkLabList){
            this.newworkData.table.hkLabList.forEach((item,index)=>{
          ...
          //    处理table数据
          if(this.newworkData.table.unitList){
            this.newworkData.table.unitList.forEach((item,index)=>{
              this.unitDataArr.push(item.detail)
            })
