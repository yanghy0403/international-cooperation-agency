  ...
  <div class="exchangeCon">
    <div class="ex-left">
      ...
      <div class="ex-nav">
        ...
        <div  class="navActive"><router-link tag="li" to="/importVisit">出访</router-link></div>
        ...
        <div class="fr-reel-left">
          <div class="fr-reelHeader">
            <div class="reel-filterCondition_1">
              <ul>
                ...
                <li class="reel-filterCondition_1_li">
                  <el-select filterable remote  :loading="foreignOrgAllloading" :remote-method="filterMethod" v-model="params['foreignOrgSelect']" placeholder="请选择国外机构">
                    <el-option
          ...
          <div class="fr-reelCenter newScrollbar">
            ...
            <div class="reelCentent" style="margin-top: 10px;">
              <div ref="picture3" style="overflow:hidden">
                <div class="moduleDiv" style="overflow:hidden">
                  <personRanking
              ...
              <div ref="picture4"  style="overflow:hidden">
                <div class="moduleDiv" style="overflow:hidden">
                  <orgRanking
                    :data="orgRankingData"
                    :visitType="visitType"
    ...
    <div  class="ex-right2" >
      ...
      <div class="personList" >
        ...
        <div class=" personHeaderNew" style="display: flex">
          <h3 class="personTitleName">出访</h3>
          <div >
        ...
        <div class="personHeader">
          ...
          <!--<div class="personSearch"  @mouseenter="clickHover(1)" @mouseleave="clickHover(2)" @click="threeLevelSearch(2)">-->
            <!--<img :src="searchIcon" alt="">-->
          <!--</div>-->
          <!--<div class="personReast " @mouseenter="clickHover(5)" @mouseleave="clickHover(6)" @click="emptyParams2">-->
            <!--<img :src="emptyIcon" alt="">-->
          <!--</div>-->
        ...
        <div v-show="isListShow" class="arrayList" v-loading="listLoading" element-loading-text="加载中...">
          <ul>
            <li v-for="(item,i) in TopicpersonList.personList" :key="i" >
              ...
              <!-- 名字 -->
              <div class="personName" @click="toPersonDetail(item.uniqueId)">{{item.visitName}}</div>
              <!-- 国家 -->
        ...
        <div style="" v-show="!isListShow" class="globaltableScroll tableList" v-loading="listLoading" element-loading-text="加载中...">
          <Table
            :height="tableHeight"
            border
            :columns="columns1"
    ...
    methods:{
      ...
      * */
      ...
      getInstituteMapData() {
        this.mapLoading = true
        // type: '出访',
        this.axios.get("/communication/globalMap/zky/out", {
          params: {
            city: this.params.citySelect,   //城市
            continent: this.params.continentSelect,  //大洲
            country: this.params.countrySelect,  //国家
