  ...
  <div class="globalMap">
    ...
    <div class="mapDiv" ref="downloadImgDIv">
      <div class="divBox" v-show="selectedCur==0">
        ...
        <div class="personDiv">
          <div class="personTitle">出、来访人次国家分布</div>
          <div class="titleName">
            <span>国家</span>
            <span>出、来访/人次</span>
          </div>
          ...
          <div class="InstituteChart scrollbar">
            <ul>
              <li v-for="(item,i) in IDcountryData" :key="i">
                <div style="width: 200px;" class="nameVal" :title="item.name">{{item.name}}</div>
    ...
    <transition name="bounce" mode="out-in">
      <div class="fullFcreen" v-if="!change">
        ...
        <div class="mapDiv" style="background: #a4aec2;" ref="downloadImgDIv">
          <div class="divBox" v-show="selectedCur==0">
            <div style="background: #a4aec2;" class="worldMap1" ref="worldMap1" ></div>
            <div style="background: #fff;flex: 1;"  class="personDiv">
              ...
              <div ref="personCountry"  class="personCountry scrollbar personCountryUnfold">
                <ul>
  ...
  export default {
    ...
    methods: {
      ...
      download() {
        ...
        let imgName = this.selectedCur==0?`出、来访人次全球分布`:'院所分布'
        setTimeout(function () {
      ...
      // 加载地图
      handleWorldMap() {
        let myChart = this.$echarts.init(this.$refs.worldMap1),
          _this = this;
        myChart.showLoading();
        let data = this.GlobalDataData.data;                 //每个国家的值
//        var normalize = this.GlobalDataData.normalize;
        let geoCoordMap = this.GlobalDataData.geoCoordMap;   //经纬度
        let maxNum = data[0].value
        let convertData = function (data) {
          if (data != undefined) {
            let res = [];
            for (let i = 0; i < data.length; i++) {
              let normalize = (((data[i].value)/maxNum)*9)+1
          ...
          series: [
            ...
            },
            {
              ...
              symbolSize: function (params) {
                return params[3]*4 > 20? 25 : params[3]*4;
      ...
      pieChart(val){
        let that = this
        this.axios
          .get("/communication/exchangeVists/mapFloatCountry", {
            params: {
          ...
          .then((res) => {
            if (res.data.code == 200) {
              ...
              let datas = [{
                name:'来访',
                value:data.mapFloatCountry.laiFangFloat.value,
              },{
                name:'出访',
                value:data.mapFloatCountry.visitOutFloat.value,
              }]
      ...
      citypieChart(val){
        let that = this
        this.axios
          .get("/communication/exchangeVists/mapFloatInstitute", {
            params: {
              city: this.cityName,
              continent: this.GlobalDataData.continent,
              country: this.GlobalDataData.country,
          ...
          .then((res) => {
            if (res.data.code == 200) {
              ...
              let datas = [{
                name:'来访',
                value:data.mapFloatInstitute.laiFangFloatCity.value,
              },{
                name:'出访',
                value:data.mapFloatInstitute.visitOutFloatCity.value,
              }]
              var myChart1 = this.$echarts.init(
                document.getElementById(val)
                // document.getElementById("tooltipBarId")
      ...
      handleTooltipPieCity(){
        let val = 'tooltipBarCityId'
        this.citypieChart(val)
      },
      // 国籍分布右侧
      handlePersonCountry() {
      ...
      handleCHWWorldMap() {
        ...
        var data = this.newInstituteData.mapData

        var geoCoordMap = this.newInstituteData.city
        // var geoCoordMap = {
        //   齐齐哈尔: [123.97, 47.33],
        ...
        let option = {
          ...
          tooltip: {
            ...
            formatter: (params) => {
              ...
              this.tooltipcityName = params.data.name
              let tipHtml =
                '<div id="tooltipBarCityId" style="width:230px;height: 129px;background:#48546d; opacity: 0.85;border-radius: 12px;"></div>';
              setTimeout(function () {
                _this.handleTooltipPieCity();
              }, 100);
              return tipHtml;
            },
          },
