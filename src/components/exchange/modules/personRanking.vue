<template>
  <div class="subsidize">
    <div class="indexTitleDiv">
      <div class="titleName">全院{{visitType}}人次单位排名</div>
      <div class="operating">
    ...
    <div class="subsidizeCharts" id="personChartImg1"  v-show="isShowChart" >
        ...
        <div class="rankCon" :style="{height:rankConrHeight}">
          <div ref="rankConBoxDiv">
            ...
            <div class="conItem" v-for="(item,index) in foundingData['chartData']" :key="index">
              ...
              <div class="conRight">
                <div  class="colorDiv" :style="{width:(((Number(item.value))/Number(rankRange[6])*(12.1/14))*100+'%'),marginLeft:((rangeItemWidth/2)+'px') } "></div>
