      ...
      <div id="subsidizeList" ref="myTableImg" v-show="!isShowChart">
        <table>
          ...
          <tr v-for="(item,i) in tableData1" :key="i">
            <td>{{item['year']}}</td>
            <td>{{item['approval']}}</td>
            <td>{{item['scienceDepartment']}}</td>
            <td>{{item['internationalPartner']}}</td>
          </tr>
          </tbody>
        </table>
      </div>
          ...
          series: [
            {
              ...
              data: _this.foundingData['internationalPartner']
            },
            {
              name: '科技部国际合作项目',
              type: 'bar',
              ...
              data: _this.foundingData['scienceDepartment']
            },      {
              name: '外专局引智项目',
              type: 'bar',
              barWidth : 10,
              ...
              data: _this.foundingData['approval']
            },
          ]
        };
