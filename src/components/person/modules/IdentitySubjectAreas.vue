  ...
  methods: {
    ...
    handleSubjectAreas() {
      ...
      myChart.on("click", function (params) {
        ...
        that.axios
          .get("/international/topic/subSubjectIdentityPie", {
            params: {
              nowPage: that.subjectData.params["nowPage"],
              limit: that.subjectData.params["limit"],
              ...
              subject: that.subjectData.params["selectSelect"],
          ...
          .then((res) => {
            if (res.data.code == 200) {
              var subSubject = res.data.data[0].subSubject;            
                if (seriesData.length >= 2) {
