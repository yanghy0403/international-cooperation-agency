<template>
  <div class="globalMap">
    <div class="indexTitleDiv">
      <div class="titleName">
        <span @click.stop="selectedCur=0" :class="{selectAcitve:selectedCur==0}">国籍分布</span>
  ...
  export default {
    ...
    methods: {
        ...
        let option = {
          ...
          tooltip: {
            ...
            formatter: (params) => {
              ...
              var tipHtml =
                '<div id="tooltipBarId" style="width:300px;height: 182px;background:#48546d; opacity: 0.85;border-radius: 12px;"></div>';
          ...
          series: [
            ...
            },
            {
              ...
              return params[3]*6>35?30: params[3]*6
            },
              showEffectOn: "render",
              rippleEffect: {
                period: 4, //动画时间，值越小速度越快
      ...
      pieChart(val){
        let that = this
        this.axios
          .get("/international/topic/globalWorldMap/detail", {
            params: {
            nowPage: that.GlobalDataData.params["nowPage"],
              limit: that.GlobalDataData.params["limit"],
              year: that.GlobalDataData.params["yearSelect"],
              city: that.GlobalDataData.params["citySelect"],
              continent: that.GlobalDataData.params["continentSelect"],
              country: this.countryName,
              subject: that.GlobalDataData.params["selectSelect"],
              personType: that.GlobalDataData.params["personTypeSelect"],
          },
          })
          .then((res) => {
        ...
        let option = {
          ...
          tooltip: {
            ...
            formatter: (params) => {
              ...
              var tipHtmlCity =
                '<div id="tooltipBarCityId" style="width:300px;height: 180px;background:#48546d; opacity: 0.85;border-radius: 12px;"></div>';
              // '<div id="tooltipBarId" style="width:345px;height: 194px;background:#48546d; opacity: 0.85;border-radius: 12px;"></div>';
              setTimeout(function () {
          ...
          series: [
            {
              ...
              data: convertData(data),
              symbolSize: function (params) {
              return params[3]*5>35?20: params[3]*5
            },
              showEffectOn: "render",
              rippleEffect: {
                scale: 5,
      ...
      handleFloatInstitutes() {
        this.axios.get("/international/topic/InsMap/detail",{params: {
          nowPage: this.GlobalDataData.params["nowPage"],
              limit: this.GlobalDataData.params["limit"],
              year: this.GlobalDataData.params["yearSelect"],
              instCity: this.cityName,
              continent: this.GlobalDataData.params["continentSelect"],
              country: this.GlobalDataData.params["countrySelect"],
              subject: this.GlobalDataData.params["selectSelect"],
