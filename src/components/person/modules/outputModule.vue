  ...
  <div class="outputCon">
    <div class="titleDiv2">
      ...
      <!--<div class="titleCenter">-->
        <!--<div @click="changePaperType(1)" :style="isShowPeriodical?style:''">期刊论文（6）</div>-->
        <!--<div @click="changePaperType(2)" :style="!isShowPeriodical?style:''">会议论文（1）</div>-->
      <!--</div>-->
      <div class="operating">
    ...
    <div class="workExperience2" v-else>
      <div class="tabDIv newTable2 newScrollbargray">
          <el-table
            ...
            style="width: 98%">
            <el-table-column
              v-for="(subitem,subindex) in tableTitle.length"
              key="subindex"
              align="center"
              :prop="tableTitleLabel[subindex]"
              :label="tableTitle[subindex]"
              min-width="290"
            >
            </el-table-column>
          </el-table>
