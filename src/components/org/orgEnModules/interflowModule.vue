  ...
  <div>
    ...
    <div class="workExperience2" v-else>
      <div class="tabDIv newTable2 newScrollbargray">
        <div v-for="(item, index) in itemTableTitle" :key="index">
          ...
          <el-table :data="item.list" style="width: 98%" v-if="item.source == '交流'">
            ...
            <el-table-column align="center" prop="enper" label="哈佛大学访问中科院人次数">
            </el-table-column>
            <el-table-column align="center" prop="enpro" label="哈佛大学访问中科院项目数">
            </el-table-column>
            <el-table-column align="center" prop="zhper" label="中科院访问哈佛大学人次数">
            </el-table-column>
            <el-table-column align="center" prop="zhpro" label="中科院访问哈佛大学项目数">
            </el-table-column>
          </el-table>
