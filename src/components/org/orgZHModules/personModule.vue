    ...
    <div class="workExperience2" v-else>
      <div class="tabDIv newTable2 newScrollbargray">
        <div v-for="(item, index) in tableDataArr" :key="index">
          ...
          <el-table :data="item.detailArr" style="width: 98%" v-if="item.source != '奖学金人才'">
            <template>
              <el-table-column
          ...
          <el-table :data="item.detail" style="width: 98%" v-else>
            <el-table-column align="center" prop="scholarshipYear" label="年度">
            </el-table-column>
            <el-table-column align="center" prop="subject" label="研究领域">
            </el-table-column>
            <el-table-column align="center" prop="enName" label="姓名">
            </el-table-column>
            ...
            <el-table-column align="center" prop="instName" label="所属研究院/院系">
            </el-table-column>
            <el-table-column align="center" prop="admitSchool" label="录取学校">
            </el-table-column>
          </el-table>
        </div>
      </div>
