  ...
  <div class="projectDiv">
        ...
        <div class="fr-reel-left">
          ...
          <div class="fr-reelCenter newScrollbar">
            ...
            <div class="reelCentent" style="margin-top: 10px">
              ...
              <div class="moduleDiv" ref="orgRankingDiv" style="width: 730px;height: 390px;">
                <orgRanking
                  :data="fundingMonerynIstitutesData"
                  v-loading="loading"
                  element-loading-text="加载中..."
                />
              </div>
            ...
            <div class="reelBottom" ref="projectGlobalMapDiv">
              <projectGlobalMap
                :data="GlobalData"
                :InstituteData="mostInstitutesMapData"
                v-loading="loading"
                element-loading-text="加载中..."
              />
            </div>
    ...
    <div class="fr-list">
      ...
      <div class="ProjectHeader">
        <div class="header-a">
          <h3 class="projectTitleName">科技部国际合作项目</h3>
          <div class="searchDiv">
      ...
      <div class="count">
        检索到 <span>{{ personList.count }}</span
        >条结果
      </div>
      <div
        class="prjectList"
...
import mostSubjectAreas from "./modules/mostSubjectAreas";
import fundingMonery from "./modules/fundingMonery";
import orgRanking from "./modules/orgRanking";
import projectGlobalMap from "./modules/projectGlobalMap";
export default {
    ...
    return {
      ...
      columns1: [
        ...
        },
        {
          ...
          align: "center",
          render: (h, params) => {
            if (params.row.special !== "") {
              return h("span", params.row.special);
            } else {
              return h("span", "—");
            }
          },
        ...
        },
        {
          ...
          align: "center",
          render: (h, params) => {
            if (params.row.responsibleUnit !== "") {
              return h("span", params.row.responsibleUnit);
            } else {
              return h("span", "—");
            }
          },
        },
        {
          ...
          align: "center",
          render: (h, params) => {
            if (params.row.recommendDep !== "") {
              return h("span", params.row.recommendDep);
            } else {
              return h("span", "—");
            }
          },
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.country !== "") {
              return h("span", params.row.country);
            } else {
              return h("span", "—");
            }
          },
        },
        {
          ...
          render: (h, params) => {
            if (
              params.row.specialFund !== "" &&
              params.row.specialFund !== null
            ) {
              return h("span", params.row.specialFund);
            } else {
              return h("span", "—");
            }
          },
        },
        {
          ...
          align: "center",
          render: (h, params) => {
            if (params.row.expertise !== "") {
              return h("span", params.row.expertise);
            } else {
              return h("span", "—");
            }
          },
      ...
      subjectData: [],
      fundingMoneryData: [],
      fundingMonerynIstitutesData: [],
      GlobalData: {},
      mostInstitutesMapData: {},
      result: [],
    };
  },
  watch: {
  ...
  mounted() {
    ...
    // });
    this.handleSubjectDown();
    this.handleProjectClass();

    this.handleProjectNumber();
    this.handleSubjectData();
  ...
  methods: {
    ...
    handleSubjectDown() {
      this.axios
        .get("/cooperativeProject/most/expertise/searching")
        .then((res) => {
          if (res.data.code == 200) {
            this.subjectAll = res.data.data;
          }
        });
    },
    ...
    handleProjectClass() {
      this.axios
        .get("/cooperativeProject/most/special/searching")
        .then((res) => {
          if (res.data.code == 200) {
            this.projectClassAll = res.data.data;
          }
        });
    },
    ...
    handleProjectNumber() {
      ...
      var data = {
        ...
        expertise: this.params.subjectSelect,
        instName: this.params.orgSelect,
        special: this.params.projectClassSelect,
        year: this.params.yearSelect,
      };
      this.axios
        .get("/cooperativeProject/most/projectNumber", { params: data })
        .then((res) => {
          if (res.data.code == 200) {
            this.loading = false;
            this.ProjectNumData = res.data.data.mostProjectNumberMap;
          }
        });
    },
    ...
    handleSubjectData() {
      ...
      this.axios
        .get("/cooperativeProject/most/subject", { params: data })
        .then((res) => {
          if (res.data.code == 200) {
            this.loading = false;
            let newParams = JSON.parse(JSON.stringify(this.params));
            this.subjectData = {
              subject: res.data.data.mostSubjectMap.subject,
              subSubject: res.data.data.mostSubjectMap.subSubject.value,
              limit: this.params.limit,
              offset: this.params.offset,
              continent: this.params.continentSelect,
              country: countrySelect,
    ...
    handleFundingMonery() {
      ...
      this.axios
        .get("/cooperativeProject/most/fundingMonery", { params: data })
        .then((res) => {
          if (res.data.code == 200) {
            this.loading = false;
            this.fundingMoneryData = res.data.data.mostFundingMoneryMap;
          }
        });
    },
    ...
    handleFundingMonerynIstitutes() {
      ...
      this.axios
        .get("/cooperativeProject/most/fundingMonerynIstitutes", {
          params: data,
        })
        .then((res) => {
          if (res.data.code == 200) {
            this.loading = false;
            this.fundingMonerynIstitutesData =
              res.data.data.mostFundingMonerynIstitutesMap;
          }
        });
    },
    ...
    handleGlobalMap() {
      ...
      this.axios
        .get("/cooperativeProject/most/global", { params: data })
        .then((res) => {
          if (res.data.code == 200) {
            this.loading = false;
            this.GlobalData = {
              geoCoordMap: res.data.data.mostGlobalMap.jw,
              continentData: res.data.data.mostGlobalMap.country,
              limit: this.params.limit,
              offset: this.params.offset,
              continent: this.params.continentSelect,
              country: countrySelect,
    ...
    handleInstitutesMap() {
      ...
      this.axios
        .get("/cooperativeProject/most/institutes", { params: data })
        .then((res) => {
          if (res.data.code == 200) {
            this.loading = false;
            this.mostInstitutesMapData = {
              data: {
                org: {},
                cityCount: {},
                cityLongAndLat: [],
            ...
            this.mostInstitutesMapData.data.org =
              res.data.data.mostInstitutesMap.org;
            this.mostInstitutesMapData.data.cityCount =
              res.data.data.mostInstitutesMap.mapData;
            this.mostInstitutesMapData.data.cityLongAndLat.push(
              res.data.data.mostInstitutesMap.city
            );
          }
        });
    },
    ...
    handleProjectList() {
      ...
      this.axios
        ...
        .then((res) => {
          if (res.data.code == 200) {
            this.loading = false;
            this.personList = res.data.data.mostPersonListMap;
          }
        });
    },
    ...
    async handleProjectName(val) {
      this.axios
        .get("/cooperativeProject/most/personSearch", {
          params: {
            limit: this.params2.limit,
            offset: this.params2.offset,
    ...
    handelDownloadExcel() {
      this.axios
        .get("/cooperativeProject/most/export/personList", {
          params: {
            continent: this.params2.continentSelect,
            country: this.params2.countrySelect,
            city: this.params2.citySelect,
    ...
    handlePdfDownload() {
      ...
      let p5 = new Promise((resolve, reject) => {
        let projectGlobalMapDiv = _this.$refs.projectGlobalMapDiv;
        visitFun.getImgBase64(projectGlobalMapDiv).then((res) => {
          data.mapImage = res;
          resolve(true);
        });
      });
