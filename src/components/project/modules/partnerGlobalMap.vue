...
export default {
  ...
  methods: {
      ...
      var convertData = function (data) {
        if (data != undefined) {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            let size = (data[i].value/maxSize)*8+1;
            if (geoCoord) {
              res.push({
                name: data[i].name,
    ...
    pieChart(val) {
      let that = this;
      this.axios
        .get("/cooperativeProject/internationalPartners/floatCountry", {
          params: {
            continent: that.GlobalDataData.continentSelect,
            cooperationCity: that.GlobalDataData.citySelect,
            cooperationCountry: that.GlobalDataData.countrySelect,
            cooperationInst: that.GlobalDataData.foreignOrgSelect,
            instName: that.GlobalDataData.orgSelect,
            limit: that.GlobalDataData.limit,
            offset: that.GlobalDataData.offset,
            projectClass: that.GlobalDataData.projectClassSelect,
            subject: that.GlobalDataData.subjectSelect,
            year: that.GlobalDataData.yearSelect,
            executeYear: that.GlobalDataData.executeYearSelect,
            executeState: that.GlobalDataData.executeStateSelect,
          },
        })
        .then((res) => {
          if (res.data.code == 200) {
            var datas = res.data.data.floatCountryMap;
            var myChart1 = this.$echarts.init(document.getElementById(val));
            let option = {
              title: {
        ...
        let option = {
          ...
          tooltip: {
            ...
            formatter: (params) => {
              ...
              var tipHtmlCity =
                '<div id="tooltipBarCityId" style="width:400px;height: 500px;background:#48546d; opacity: 0.85;border-radius: 12px;"></div>';
              // '<div id="tooltipBarId" style="width:345px;height: 194px;background:#48546d; opacity: 0.85;border-radius: 12px;"></div>';
              setTimeout(function () {
    ...
    handleFloatInstitutes() {
      this.axios
        .get("/cooperativeProject/internationalPartners/floatInstitutes", {
          params: {
            continent: this.GlobalDataData.continentSelect,
            cooperationCity: this.GlobalDataData.cooperationCity,
            city: this.cityName,
            cooperationCountry: this.GlobalDataData.countrySelect,
            cooperationInst: this.GlobalDataData.foreignOrgSelect,
            instName: this.GlobalDataData.orgSelect,
            limit: this.GlobalDataData.limit,
            offset: this.GlobalDataData.offset,
            projectClass: this.GlobalDataData.projectClassSelect,
            subject: this.GlobalDataData.subjectSelect,
            year: this.GlobalDataData.yearSelect,
            executeYear: this.GlobalDataData.executeYearSelect,
            executeState: this.GlobalDataData.executeStateSelect,
          },
        })
        .then((res) => {
          if (res.data.code == 200) {
            var datas = res.data.data.floatInstNameMap;
